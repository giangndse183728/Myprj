 ...
 */
package sample.sp24.t2s1.filter;
...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        USER_RESOURCE.add("createItem.html");
        USER_RESOURCE.add("styleUser.css");
        USER_RESOURCE.add("inventory.html");
        ADMIN_RESOURCE = new ArrayList<>();
        ADMIN_RESOURCE.add("admin.jsp");
        ADMIN_RESOURCE.add("creatUser.html");
        ADMIN_RESOURCE.add("creatUser.jsp");
        ...
        NON_AUTHEN_RESOURCE.add("styleShopping.css");
        NON_AUTHEN_RESOURCE.add("styleViewCart.css");
        NON_AUTHEN_RESOURCE.add("styleLogin.css");
