...
public class UserDAO {
    ...
    private static final String LIST_USER = "SELECT userID, fullName, password, roleID FROM tblUsers WHERE fullName like ?";
    ...
    public boolean insert(UserDTO dto) throws SQLException {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
    ...
    public boolean insertV2(UserDTO dto) throws SQLException, ClassNotFoundException, Exception {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
