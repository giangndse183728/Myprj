      ...
      <form action="MainController" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <div class="error"> ${requestScope.USER_ERROR.fullNameError}<br> </div>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <div class="error"> ${requestScope.USER_ERROR.confirmError}<br> </div>
          </div>
          
        </div>
        <div class="-details">
          <input type="radio" name="AD" id="dot-1">
          <input type="radio" name="US" id="dot-2">
          
          <span class="gender-title">Role</span>
          <div class="category">
            <label for="dot-1">
            <span class="dot one"></span>
            <span class="gender">AD</span>
          </label>
          <label for="dot-2">
            <span class="dot two"></span>
            <span class="gender">US</span>
          </label>
